...
void updateCSRDel_omp(int numnodes, int numEdges, int32_t *indexofNodes, int32_t *edgeList, int32_t *rev_indexofNodes, int32_t *srcList, float *edgeLen, float *diff_edgeLen,
                      int32_t *diff_indexofNodes, int32_t *diff_edgeList, int32_t *diff_rev_indexofNodes, int32_t *diff_rev_edgeList, float *rev_edgeLen, float *diff_rev_edgeLen,
...
void updateCSRAdd_omp(int numnodes, int numEdges, int32_t *indexofNodes, int32_t *edgeList, int32_t *rev_indexofNodes, int32_t *srcList, float *edgeLen, float **diff_edgeLen,
                      int32_t **diff_indexofNodes, int32_t **diff_edgeList, int32_t **diff_rev_indexofNodes, int32_t **diff_rev_edgeList, float *rev_edgeLen, float **diff_rev_edgeLen,
...
#pragma omp atomic
    ...
    if (diff_edgeListSize > 0)
    {
      ...
      *diff_edgeLen = new float[diff_edgeListSize];
...
#pragma omp atomic
    ...
    if (diff_edgeListSize > 0)
    {
      ...
      float *diff_edgeLenNew = new float[diff_edgeListSize];
...
#pragma omp atomic
    ...
    if (diff_rev_edgeListSize > 0)
    {
      ...
      *diff_rev_edgeLen = new float[diff_rev_edgeListSize];
...
#pragma omp atomic
    ...
    if (diff_rev_edgeListSize > 0)
    {
      ...
      float *diff_rev_edgeLenNew = new float[diff_rev_edgeListSize];
