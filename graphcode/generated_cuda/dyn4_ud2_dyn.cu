...

{
  ...
  do{
    ...
    cudaMemcpyToSymbol(::kernel_cycle, &kernel_cycle, sizeof(int), 0, cudaMemcpyHostToDevice);
    ...
    cudaMemcpyFromSymbol(&kernel_cycle, ::kernel_cycle, sizeof(int), 0, cudaMemcpyDeviceToHost);
