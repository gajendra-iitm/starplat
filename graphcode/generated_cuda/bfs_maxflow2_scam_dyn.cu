...

{
  ...
  computeBC_kernel_1<<<numBlocks, threadsPerBlock>>>(V,E,d_scanned);
  ...
  do {
    ...
    //Kernel LAUNCH
    fwd_pass<<<numBlocks,threadsPerBlock>>>(V, d_level, d_hops_from_source, d_finished,d_residual_capacity,d_rev_residual_capacity,d_height,d_reverse_edge, d_meta, d_data, d_rev_meta, d_src, d_weight); ///DONE from varList
