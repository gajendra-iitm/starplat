...

{
  ...
  computeBC_kernel_1<<<numBlocks, threadsPerBlock>>>(V,E);
  ...
  initKernel<float> <<<numBlocks,threadsPerBlock>>>(V,d_delta,(float));

  initKernel<double> <<<numBlocks,threadsPerBlock>>>(V,d_sigma,(double));
