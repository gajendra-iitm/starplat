...

{
  ...
  while(!noNewPaths) {
    ...
    APFB0_kernel<<<numBlocks, threadsPerBlock>>>(V,E,d_cmatch,d_bfsArray);
    ...
    while(!noNewVertices) {
      ...
      cudaMemcpyToSymbol(::noNewPaths, &noNewPaths, sizeof(bool), 0, cudaMemcpyHostToDevice);
      cudaMemcpyToSymbol(::noNewVertices, &noNewVertices, sizeof(bool), 0, cudaMemcpyHostToDevice);
      APFB1_kernel<<<numBlocks, threadsPerBlock>>>(V,E,d_meta,d_data,d_bfsArray,d_rmatch,d_predeccesor);
      cudaDeviceSynchronize();
      cudaMemcpyFromSymbol(&nc, ::nc, sizeof(int), 0, cudaMemcpyDeviceToHost);
    ...
    cudaMemcpyToSymbol(::nc, &nc, sizeof(int), 0, cudaMemcpyHostToDevice);
    APFB2_kernel<<<numBlocks, threadsPerBlock>>>(V,E,d_rmatch,d_compress);
    cudaDeviceSynchronize();
    cudaMemcpyFromSymbol(&nc, ::nc, sizeof(int), 0, cudaMemcpyDeviceToHost);
    ...
    while(!compressed) {
      ...
      cudaMemcpyToSymbol(::nc, &nc, sizeof(int), 0, cudaMemcpyHostToDevice);
      cudaMemcpyToSymbol(::compressed, &compressed, sizeof(bool), 0, cudaMemcpyHostToDevice);
      APFB3_kernel<<<numBlocks, threadsPerBlock>>>(V,E,d_compress,d_predeccesor,d_cmatch,d_compress_next,d_rmatch);
      cudaDeviceSynchronize();
      cudaMemcpyFromSymbol(&nc, ::nc, sizeof(int), 0, cudaMemcpyDeviceToHost);
      ...
      cudaMemcpyToSymbol(::nc, &nc, sizeof(int), 0, cudaMemcpyHostToDevice);
      APFB4_kernel<<<numBlocks, threadsPerBlock>>>(V,E,d_compress_next,d_compress);
      cudaDeviceSynchronize();
      cudaMemcpyFromSymbol(&nc, ::nc, sizeof(int), 0, cudaMemcpyDeviceToHost);
    ...
    cudaMemcpyToSymbol(::nc, &nc, sizeof(int), 0, cudaMemcpyHostToDevice);
    APFB5_kernel<<<numBlocks, threadsPerBlock>>>(V,E,d_rmatch,d_cmatch);
    cudaDeviceSynchronize();
    cudaMemcpyFromSymbol(&nc, ::nc, sizeof(int), 0, cudaMemcpyDeviceToHost);
