...
class dsl_cpp_generator {
 ...
 public:
  ...
  void generateExpr(Expression* expr, bool isMainFile, bool isAtomic = false, bool isSecondArg = false);   //isSecondArg is added to remove the duplicacy of semicolons at the time of assignment
  ...
  void generate_exprProcCall(Expression* expr, bool isMainFile, bool isSecongArg = false); //isSecondArg is added to remove the duplicacy of semicolons at the time of assignment
